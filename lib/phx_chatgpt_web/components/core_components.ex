defmodule PhxChatgptWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhxChatgptWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhxChatgptWeb.Gettext, "errors", msg, opts)
    end
  end
